...
6. Capture attempt, response/artifact, performance conditions, and all support use.
...
9. Produce positive, negative, or neutral evidence with independence, novelty, difficulty, transfer/retention distance, trust, and confidence.
...
The planner also honors continuity and sustainability. An action candidate is an in-memory option, not a persisted task. Only selected actions become plan blocks.
...
Eligible actions may then be ranked by goal impact, critical-path relevance, evidence need, retention urgency, expected learning value, continuity, learner choice, time cost, cognitive/production load, and recent workload.
